...
function PdfAnnotator({ pdfSrc, highlights = [], onNewHightlight, onShareQuote, onDeleteHighlight, onUpdateHighlight, isDualPageArrow, pdfScaleValue, }) {
    ...
    return (react_1.default.createElement("div", { style: { height: "100%", width: "100%", position: "relative" } },
        react_1.default.createElement(PdfLoader_1.default, { url: pdfSrc, beforeLoad: react_1.default.createElement(Spinner_1.Spinner, null), onError: (err) => {
        ...
        react_1.default.createElement("div", { className: "Highlight__popup__dialog" },
            react_1.default.createElement("div", { onClick: () => onDeleteClick() },
                react_1.default.createElement("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
                    react_1.default.createElement("g", { clipPath: "url(#clip0_2009_18)" },
            ...
            react_1.default.createElement("div", { className: "", onClick: () => onEditClick() },
                react_1.default.createElement("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
                    ...
                    react_1.default.createElement("path", { d: "M18.5 2.50001C18.8978 2.10219 19.4374 1.87869 20 1.87869C20.5626 1.87869 21.1022 2.10219 21.5 2.50001C21.8978 2.89784 22.1213 3.4374 22.1213 4.00001C22.1213 4.56262 21.8978 5.10219 21.5 5.50001L12 15L8 16L9 12L18.5 2.50001Z", stroke: "#fff", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }))))))) : null;
