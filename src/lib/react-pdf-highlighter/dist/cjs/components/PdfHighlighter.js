...
class PdfHighlighter extends react_1.PureComponent {
    constructor(props) {
        ...
        this.renderTip = () => {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null, react_dom_1.default.createPortal(react_1.default.createElement(TipContainer_1.default, { scrollTop: this.viewer.container.scrollTop, pageBoundingRect: pageBoundingRect, style: {
                    left: boundingRect.left + boundingRect.width / 2,
                    top: boundingRect.top,
                } }, tipChildren), page.node, "this is react")));
            // return (
            // <TipContainer
    ...
    findOrCreateHighlightLayer(page) {
        ...
        const textLayerDiv = textLayer.textLayerDiv || textLayer.div;
        if (!textLayerDiv) {
            return null;
        }
        return (0, pdfjs_dom_1.findOrCreateContainerLayer)(textLayerDiv, "PdfHighlighter__highlight-layer");
    }
