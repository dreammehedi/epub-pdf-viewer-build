...
class PdfLoader extends react_1.Component {
    ...
    load() {
        ...
        const activeWorkerSrc = workerSrc || `https://unpkg.com/pdfjs-dist@${pdf_1.version}/build/pdf.worker.min.js`;
        if (typeof activeWorkerSrc === "string") {
            pdf_1.GlobalWorkerOptions.workerSrc = activeWorkerSrc;
        }
        Promise.resolve()
