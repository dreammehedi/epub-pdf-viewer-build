...
import Tip, { HighlightTip } from "./components/Tip";
...
export function PdfAnnotator({ pdfSrc, highlights = [], onNewHightlight, onShareQuote, onDeleteHighlight, onUpdateHighlight, isDualPageArrow, pdfScaleValue, }) {
    ...
    return (React.createElement("div", { style: { height: "100%", width: "100%", position: "relative" } },
        React.createElement(PdfLoader, { url: pdfSrc, beforeLoad: React.createElement(Spinner, null), onError: (err) => {
            ...
            scrollRef: (scrollTo) => {
                ...
                return (React.createElement(Tip, { onOpen: transformSelection, onHighLightClick: () => {
        ...
        isDualPageArrow && (React.createElement(React.Fragment, null,
            React.createElement("div", { style: { right: 10 }, onClick: handleNextPage, className: "dual_page_arrow" },
                React.createElement("svg", { width: "50", height: "50", viewBox: "0 0 125 125", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
                    React.createElement("path", { d: "M90.9423 56.4943L44.0653 17.4301C42.4718 16.1119 40.4208 15.479 38.3615 15.6698C36.3022 15.8607 34.4025 16.8598 33.0783 18.4484C31.7541 20.037 31.1135 22.0856 31.2965 24.1456C31.4796 26.2056 32.4716 28.1091 34.0552 29.4392L73.7297 62.4991L34.0552 95.559C32.4655 96.8873 31.4681 98.7923 31.282 100.856C31.0959 102.919 31.7364 104.971 33.0628 106.563C34.3892 108.154 36.293 109.154 38.356 109.342C40.419 109.531 42.4725 108.893 44.0653 107.568L90.9423 68.5034C91.8213 67.769 92.5283 66.8507 93.0135 65.8131C93.4986 64.7756 93.7501 63.6442 93.7501 62.4988C93.7501 61.3535 93.4986 60.2221 93.0135 59.1845C92.5283 58.147 91.8213 57.2286 90.9423 56.4943Z", fill: "#333" }))),
            React.createElement("div", { style: { left: 10 }, onClick: handlePrevPage, className: "dual_page_arrow" },
                React.createElement("svg", { width: "50", height: "50", viewBox: "0 0 125 125", fill: "none", xmlns: "http://www.w3.org/2000/svg", style: { rotate: "180deg" } },
                    React.createElement("path", { d: "M90.9423 56.4943L44.0653 17.4301C42.4718 16.1119 40.4208 15.479 38.3615 15.6698C36.3022 15.8607 34.4025 16.8598 33.0783 18.4484C31.7541 20.037 31.1135 22.0856 31.2965 24.1456C31.4796 26.2056 32.4716 28.1091 34.0552 29.4392L73.7297 62.4991L34.0552 95.559C32.4655 96.8873 31.4681 98.7923 31.282 100.856C31.0959 102.919 31.7364 104.971 33.0628 106.563C34.3892 108.154 36.293 109.154 38.356 109.342C40.419 109.531 42.4725 108.893 44.0653 107.568L90.9423 68.5034C91.8213 67.769 92.5283 66.8507 93.0135 65.8131C93.4986 64.7756 93.7501 63.6442 93.7501 62.4988C93.7501 61.3535 93.4986 60.2221 93.0135 59.1845C92.5283 58.147 91.8213 57.2286 90.9423 56.4943Z", fill: "#333" })))))));
}
class HighlightTransform extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
            note: false,
    ...
    render() {
        ...
        return (React.createElement(Popup, { popupContent: ((_a = highlight === null || highlight === void 0 ? void 0 : highlight.comment) === null || _a === void 0 ? void 0 : _a.text) ? (React.createElement(HighlightPopup, { comment: highlight === null || highlight === void 0 ? void 0 : highlight.comment, onDeleteClick: () => {
                    onDeleteHighlight === null || onDeleteHighlight === void 0 ? void 0 : onDeleteHighlight(highlight.id);
                    hideTip();
                }, onEditClick: () => {
                    // hideTip();
                    setNote(true);
                    setTip(highlight, (highlight) => (React.createElement(NotePopup, { onEnd: () => setNote(false), comment: highlight.comment, onUpdateData: (newComment) => {
                ...
                } })) : (React.createElement(HighlightTip, { onDelete: () => {
                    onDeleteHighlight === null || onDeleteHighlight === void 0 ? void 0 : onDeleteHighlight(highlight.id);
                    hideTip();
                }, handleNote: () => {
                    hideTip();
...
class NotePopup extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: "Tip" },
            React.createElement("div", { className: "Tip__card" },
                React.createElement("div", null,
                    React.createElement("textarea", { value: this.state.text, onChange: (e) => {
