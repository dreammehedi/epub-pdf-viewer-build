...
export class PdfHighlighter extends PureComponent {
    constructor(props) {
        ...
        this.renderTip = () => {
            ...
            return (React.createElement(React.Fragment, null, ReactDOM.createPortal(React.createElement(TipContainer, { scrollTop: this.viewer.container.scrollTop, pageBoundingRect: pageBoundingRect, style: {
    ...
    findOrCreateHighlightLayer(page) {
        ...
        return findOrCreateContainerLayer(textLayerDiv, "PdfHighlighter__highlight-layer");
    }
